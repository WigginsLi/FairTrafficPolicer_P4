...
```bash
mx h1
python3 send.py --n-pkt 1000 --n-hh 2 --n-sfw 0 --p-hh 1
```
...
```bash
python3 cm-sketch-controller.py --eps 0.1 --n 1000 --mod 28 --option decode
```
...
```bash
mx h1
python3 send.py --n-pkt 100000 --n-hh 10 --n-sfw 990 --p-hh 0.95
```
